...
import 'package:barnasht_app/features/auth/presentation/views/widgets/signup_widgets/signup_view_body_bloc_consumer.dart';
...
class SignupView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(body: SafeArea(child: const SignupViewBodyBlocConsumer())),
    );
  }
}
